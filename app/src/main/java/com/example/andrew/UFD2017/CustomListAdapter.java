...
public class CustomListAdapter extends ArrayAdapter<String> {
    ...
    public CustomListAdapter(Activity context, Player[] playerListArray_con, String[] itemname) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        txtGames.setText(String.valueOf(playerListArray[position].getStats(2016).games + " games"));
